...
export function StepSettings({ data, updateData, errors, generateTitle }: StepSettingsProps) {
  ...
  return (
    <div aria-live="polite">
      <h2 className="mb-2 text-2xl font-bold text-[#111827]">어떤 분들이 올 수 있나요?</h2>
      ...
      <div className="mb-5">
        ...
        <input
          ...
          maxLength={50}
          className={`w-full rounded-[16px] border bg-white px-4 py-3 text-[#111827] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#0066FF]/50 ${
        ...
        {suggestedTitle && !data.title && (
          <button
            ...
            className="mt-1 text-xs text-[#F4A261] hover:underline"
          >
        ...
        <div className="mb-5 flex items-center justify-between rounded-[16px] border border-[#E8ECF0] bg-white px-4 py-3">
          ...
          <button
            ...
            className={`relative h-6 w-12 flex-shrink-0 rounded-full transition-colors ${
              data.allowGuests ? "bg-[#0066FF]" : "bg-[#CBD5E1]"
            }`}
          >
            <span
...
function TeamMatchSettings({
  ...
  return (
    <div aria-live="polite">
      <h2 className="mb-2 text-2xl font-bold text-[#111827]">팀 대결 설정</h2>
