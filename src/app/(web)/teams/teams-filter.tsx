...
const selectCls =
  "h-10 appearance-none rounded-[12px] border border-[var(--color-border)] bg-[var(--color-card)] pl-3 pr-8 text-sm text-[var(--color-text-primary)] focus:border-[var(--color-accent)]/60 focus:outline-none cursor-pointer";
